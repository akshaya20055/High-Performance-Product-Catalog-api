...
from app.models import Product  # Ensure models are imported for metadata
...
def run_migrations_online_sync(connection: Connection) -> None:
    """Synchronous runner helper for async migration."""
    context.configure(connection=connection, target_metadata=target_metadata)
...
if context.is_offline_mode():
    ...
    try:
        ...
        # If there is an active loop (e.g. inside testing or uvicorn), run in loop
